...
#Frequency table to track occurrence of words
freqTable = dict()
...
#Avg value of sentences from text
averageVal = int(sumValues / len(sentenceValue))

#Add sentences into summary
summary = ''
for sentence in sentences:
  if (sentence in sentenceValue) and (sentenceValue[sentence] > 1.3 * averageVal):
    summary += " " + sentence
print(summary)
